      ...
      <div class="st_main">
        <main>
          ...
          <section class="section__even">
            ...
            <p class="mt-4 fw-bold text-decoration-underline">スタッフ削除</p>
            <form class="bg-primary-subtle p-4 mt-4" method="post" action="./staff_delete_done.php">
              <div class="mb-3">
              ...
              <div class="mb-3">
                ...
                <input class="form-control" type="text" name="name" value="<?php echo $staff_name; ?>" disabled readonly>
              </div>
              <div>
                <input class="form-control" type="hidden" name="code" value="<?php echo $staff_code; ?>">
                <input class="form-control" type="hidden" name="name" value="<?php echo $staff_name; ?>">
              </div>
              <div class="mb-3">
                <div class="mt-5 mb-2 fw-bold">対象のスタッフデータを削除してよろしいですか？</div>
                <button class="btn btn-primary" type="submit" value="登録">Submit</button>
