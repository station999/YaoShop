        ...
        <main>
          ...
          <section class="section__even">
            ...
            <table class="table_contact-form">
              <tr class="tr_cttfm">
                <th class="th_cttfm">スタッフコード 2</th>
              ...
              <tr class="tr_cttfm">
                <th class="th_cttfm"> </th>
                <td class="td_cttfm">
                   対象のスタッフデータを削除してよろしいですか？</td>
              </tr>
            </table>
            <form class="form_contact" method="post" action="./staff_delete_done.php">
              <input class="dta_select" type="hidden" name="code" value="<?php echo $staff_code; ?>">
              <input class="dta_input" type="hidden" name="name" value="<?php echo $staff_name; ?>">
              <table class="table_contact-form">
                <tr class="tr_cttfm">
                  <th class="th_cttfm">
