      ...
      <div class="st_container lyst_main">
        <main>
          ...
          <section class="section__even">
            ...
            <h2>スタッフ情報参照</h2>
            <form class="form_contact" method="post" action="staff_branch.php">
              <input class="dta_select" type="hidden" name="staffcode" value="<?php echo $staff_code; ?>">
              <table class="table_contact-form">
                <tr class="tr_cttfm">
                  <th class="th_cttfm">スタッフコード </th>
                  <td class="td_cttfm"> <?php echo $staff_code; ?></td>
                </tr>
                <tr class="tr_cttfm">
                  <th class="th_cttfm">スタッフ名 </th>
                  <td class="td_cttfm"> <?php echo $staff_name; ?></td>
                </tr>
                <tr class="tr_cttfm">
                  <th class="th_cttfm">
                  ...
                  <td class="td_cttfm">
                    <input class="dta_select" type="submit" name="edit" value="修正">
                    <input class="dta_select" type="submit" name="delete" value="削除">
                  </td>
                </tr>
                <tr class="tr_cttfm">
                  <th class="th_cttfm">
