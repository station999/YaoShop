      ...
      <div class="st_main">
        <main>
          ...
          <section class="section__even">
            ...
            <p class="mt-4 fw-bold text-decoration-underline">スタッフ情報参照</p>
            <form class="bg-primary-subtle p-4 mt-4" method="post" action="./staff_branch.php">
              <input class="form-control" type="hidden" name="staffcode" value="<?php echo $staff_code; ?>">
              <div class="mb-3">
              ...
              <div class="mb-3">
                ...
                <input class="form-control" type="email" name="email" value="<?php echo $staff_email; ?>" disabled readonly>
              </div>
              <div class="mb-3">
