      ...
      <div class="st_main">
        <main>
          ...
          <section class="section__even">
            ...
            <p class="mt-4 fw-bold text-decoration-underline">スタッフ修正</p>
            <form class="bg-primary-subtle p-4 mt-4" method="post" action="./staff_edit_check.php">
              <input class="form-control" type="hidden" name="code" value="<?php echo $staff_code; ?>">
              <div class="mb-3">
                <label class="form-label" for="name">Staff Code</label>
                <input class="form-control" type="text" value="<?php echo $staff_code; ?>" disabled readonly>
              </div>
              <div class="mb-3">
                <label class="form-label" for="name">Name</label>
                <input class="form-control" type="text" name="name" value="<?php echo $staff_name; ?>">
                <div class="form-text" id="emailHelp">Please enter your full name for comfirmation.</div>
              </div>
              <div class="mb-3">
                <label class="form-label" for="Email1">Email address</label>
                <input class="form-control" type="email" name="email" value="<?php echo $staff_email; ?>" id="exampleInputEmail1">
              </div>
              <div class="mb-3">
                <label class="form-label" for="pass">Password</label>
                <input class="form-control" type="password" name="pass" id="exampleInputPassword1">
                <div class="form-text" id="emailHelp">You will need to reset your password.</div>
              </div>
              <div class="mb-3">
                ...
                <div class="form-text" id="emailHelp">Please enter your password again for comfirmation.</div>
              </div>
