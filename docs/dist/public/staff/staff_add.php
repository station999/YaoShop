...
<html lang="ja">
  <head><meta charset="UTF-8">
    ...
    <!-- <link rel="stylesheet" href="C:/D/adsan-web-design/docs/dist/assets/css/style.css"> -->
  ...
  <body>
      ...
      <div class="st_container lyst_main">
        <main>
          ...
          <section class="section__even">
            <form class="form_contact" method="post" action="staff_add_check.php">
              <table class="table_contact-form">
                <tr class="tr_cttfm">
                  ...
                  <td class="td_cttfm">
                    <input class="dta_input" type="text" name="name">
                  </td>
                </tr>
                <tr class="tr_cttfm">
                  <th class="th_cttfm">
                  ...
                  <td class="td_cttfm">
                    <input class="dta_input" type="email" name="email" required>
                  </td>
                </tr>
                <tr class="tr_cttfm">
                  <th class="th_cttfm">
                ...
                <tr class="tr_cttfm">
                  <th class="th_cttfm">
                    <label for="pass2">Password agein</label>
                  </th>
                  <td class="td_cttfm">
    ...
    </div><script src="https://example.com/assets/js/base.js" charset="utf-8"></script>
