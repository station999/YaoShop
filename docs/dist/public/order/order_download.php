      ...
      <header class="st_header">
        <div class="ly_hdr_inner">
          <div class="el_top-logo">
            <a href="#{siteDomain}"> 
              <img class="img_plncd frm_pln_img" src="#{workDirPath}assetsimagescommonlogologo.png" style="height: 50px;" alt="Home Logo">
            </a>
          </div>
        ...
        <main>
          ...
          <section class="section__even">
            ...
            <form method="post" action="order_download_done.php">
              <?php pulldown_year();?><span>年</span>
              <?php pulldown_month();?><span>月</span>
              <?php pulldown_day();?><span>日</span><br>
              <br>
              <input type="submit" value="データ抽出">
            </form>
            <br>
            <br>
