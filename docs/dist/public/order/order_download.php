      ...
      <div class="st_main">
        <main>
          ...
          <section class="container p-4">
            <?php
                require_once('../common/functions/pulldown_ymd.php');
            ?>
            
            <p class="mt-4 fw-bold text-decoration-underline">ダウンロード対象選択</p>
            <form class="bg-primary-subtle p-4 mt-4" method="post" action="order_download_done.php" enctype="multipart/form-data">
              <p>ダウンロードしたい注文日を選んでください。</br></p>
              <?php pulldown_year();?><span class="mx-1"></span>
              <?php pulldown_month();?><span class="mx-1"></span>
              <?php pulldown_day();?><br>
              <div class="mb-3 mt-5">
                <button class="btn btn-primary" type="submit" value="データ抽出">Submit</button>
                <button class="btn btn-secondary" type="button" value="戻る" onclick="history.back()">Buck</button>
              </div>
            </form>
            <button class="btn btn-warning my-3" type="button"><a href="../staff_login/staff_top.php">スタッフメニュー</a></button>
          </section>
        </main>
      </div>
