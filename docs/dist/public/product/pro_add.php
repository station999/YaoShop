      ...
      <div class="st_main">
        <main>
          ...
          <section class="container p-4">
            <p class="mt-4 fw-bold text-decoration-underline">商品登録</p>
            <form class="bg-primary-subtle p-4 mt-4" method="post" action="./pro_add_check.php" enctype="multipart/form-data">
              <div class="mb-3">
              ...
              <div class="mb-3">
                <label class="form-label" for="gazou">Select image</label>
                <input class="form-control" type="file" name="gazou">
              </div>
              <div class="mb-3 mt-5">
