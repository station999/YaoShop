      ...
      <div class="st_container lyst_main">
        <main>
          ...
          <section class="section__even">
            <form class="form_contact" method="post" action="./pro_add_check.php" enctype="multipart/form-data">
              <table class="table_contact-form">
                ...
                <tr class="tr_cttfm">
                  ...
                  <td class="td_cttfm">
                    <input class="dta_input" type="text" name="price">
                  </td>
                </tr>
                <tr class="tr_cttfm">
                  <th class="th_cttfm">
                  ...
                  <td class="td_cttfm">
                    <input class="dta_input" type="file" name="gazou">
                  </td>
                </tr>
                <tr class="tr_cttfm">
                  <th class="th_cttfm">
