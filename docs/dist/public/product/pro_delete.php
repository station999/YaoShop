      ...
      <div class="st_main">
        <main>
          ...
          <section class="container p-4">
            ...
            <p class="mt-4 fw-bold text-decoration-underline">商品削除</p>
            <form class="bg-primary-subtle p-4 mt-4" method="post" action="./pro_delete_done.php">
              <input class="dta_select" type="hidden" name="code" value="<?php echo $pro_code; ?>">
              <input class="dta_input" type="hidden" name="name" value="<?php echo $pro_name; ?>">
              <input class="dta_input" type="hidden" name="gazou_name" value="<?php echo $pro_gazou_name; ?>">
              <div class="mb-3">
                <label class="form-label" for="code">Product Code :</label>
                <input class="form-control" type="text" value="<?php echo $pro_code; ?>" disabled readonly>
              </div>
              <div class="mb-3">
              ...
              <div class="mb-3">
                <div class="mt-5 mb-2 fw-bold">対象の商品データを削除してよろしいですか？</div>
