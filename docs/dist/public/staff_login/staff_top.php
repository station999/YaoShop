          ...
          <section class="section__even">
            <h2>ショップ管理トップメニュー
              <table class="table_contact-form">
                <tr class="tr_cttfm">
                  <td class="td_cttfm"><a href="./../staff/staff_list.php">スタッフ管理画面</a></td>
                </tr>
                <tr class="tr_cttfm">
                  <td class="td_cttfm"><a href="./../product/pro_list.php">商品管理画面</a></td>
                </tr>
                <tr class="tr_cttfm">
                  <td class="td_cttfm"><a href="./../order/order_download.php">注文データ ダウンロード</a></td>
                </tr>
                <tr class="tr_cttfm">
                  <td class="td_cttfm"><a href="./staff_logout.php">ログアウト</a></td>
                </tr>
              </table>
            </h2>
          </section>
