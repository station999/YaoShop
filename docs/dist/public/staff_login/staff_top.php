      ...
      <div class="st_main">
        <main>
          ...
          <section class="container p-4">
            <p class="mt-4 fw-bold text-decoration-underline">ショップ管理トップメニュー</p>
            <ul class="list-group list-group-flush p-4 mt-2">
              <li class="list-group-item text-bg-light"><a href="./../staff/staff_list.php">スタッフ管理画面</a></li>
              <li class="list-group-item text-bg-light"><a href="./../product/pro_list.php">商品管理画面</a></li>
              <li class="list-group-item text-bg-light"><a href="./../order/order_download.php">注文データ ダウンロード</a></li>
              <li class="list-group-item text-bg-light"><a href="./staff_logout.php">ログアウト</a></li>
            </ul>
          </section>
        </main>
      </div>
